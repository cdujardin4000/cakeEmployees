...
<body>
    <nav class="top-nav">
        <div class="top-nav-title">
            <a href="<?= $this->Url->build('/') ?>"><img src="https://www.cakephp.org/img/flags/We-bake-with-CakePHP.png" width="100px;"></a>
        </div>
    ...
    <footer>
        <p>copyright © EPFC – WFPO 2021 Made with <strong>❤</strong> by Dujardin Cédric  <a href="#">cdujardin4000</a>.</p>
    </footer>
